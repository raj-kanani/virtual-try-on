...
shirts = [cv2.imread("cloth\shirt1.png", -1),
          cv2.imread("cloth\shirt2.png", -1),
          cv2.imread("cloth\shirt51.jpg", -1),]
          # cv2.imread("cloth\shirt6.png", -1)]

for a in range(1, 5):
    cv2.imshow('shirt' + str(a), shirts[a - 1])
cv2.waitKey(1)
pants = [cv2.imread("cloth\pant7.jpg", -1), cv2.imread("cloth\pant21.png", -1)]
for b in range(1, 3):
...
while True:
    ...
    imgarr = ["cloth\pant7.jpg", 'cloth\pant21.png']
    # i=input("Enter the pant number you want to try")
    ...
    for (x, y, w, h) in faces:
        ...
        # resize all,the masks you made,the origional image,everything
